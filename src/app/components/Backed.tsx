      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-6">
        <div className="relative rounded-2xl ring-1 ring-gray-200 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-6 sm:p-8 md:p-10 lg:p-14 bg-[#F8FAF9] border-t md:border-t-0 md:border-l border-gray-200">
              <h4 className="text-sm sm:text-base md:text-lg font-medium text-[#17181D] mb-3 sm:mb-4">
                What this means for your projects
              </h4>
              <ul className="space-y-3 sm:space-y-4 text-gray-700 text-xs sm:text-sm md:text-base leading-relaxed">
                <li className="flex items-start gap-2 sm:gap-3">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#3EA442] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="rounded-lg bg-white ring-1 ring-gray-200 p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-1.5 sm:mb-2">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#3EA442]" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <div className="text-[10px] sm:text-xs uppercase tracking-wide text-gray-500">Assurance</div>
                  </div>
                  <div className="text-xs sm:text-sm md:text-base text-[#17181D] font-medium">Credential checks & region-specific compliance</div>
                </div>
                <div className="rounded-lg bg-white ring-1 ring-gray-200 p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-1.5 sm:mb-2">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#3EA442]" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="text-[10px] sm:text-xs uppercase tracking-wide text-gray-500">Templates</div>
                  </div>
                  <div className="text-xs sm:text-sm md:text-base text-[#17181D] font-medium">Sector-ready roles and scopes for energy projects</div>
                </div>
                <div className="rounded-lg bg-white ring-1 ring-gray-200 p-3 sm:p-4 sm:col-span-2">
                  <div className="flex items-center gap-2 mb-1.5 sm:mb-2">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#3EA442]" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
                    </svg>
                    <div className="text-[10px] sm:text-xs uppercase tracking-wide text-gray-500">Governance</div>
                  </div>
                  <div className="text-xs sm:text-sm md:text-base text-[#17181D] font-medium">Auditable records, access controls, and clean handover packs</div>
                </div>
              </div>

              <div className="mt-6 sm:mt-8 h-px w-full bg-gray-200" />
